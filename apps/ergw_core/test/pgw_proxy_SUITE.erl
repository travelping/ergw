		  ...
		  {static,
		   [
		    ...
		    {<<"lb-1.apn.epc.mnc000.mcc700.3gppnetwork.org">>, {300,64536},
		     [{'x-3gpp-pgw','x-s5-gtp'},{'x-3gpp-pgw','x-s8-gtp'},
		      {'x-3gpp-pgw','x-gn'},{'x-3gpp-pgw','x-gp'}],
		     <<"topon.s5s8.pgw-2.epc.mnc001.mcc001.3gppnetwork.org">>},

		    %% A/AAAA record alternatives
		    {<<"topon.s5s8.pgw.epc.mnc001.mcc001.3gppnetwork.org">>, ?MUST_BE_UPDATED, []},
		    {<<"topon.s5s8.pgw-2.epc.mnc001.mcc001.3gppnetwork.org">>, ?MUST_BE_UPDATED, []},
...
-define(CONFIG_UPDATE_MULTIPLE_PROXY_SOCKETS,
	[{[sockets, cp, ip], localhost},
	 ...
	 {[node_selection, {default, 2}, 2, <<"topon.s5s8.pgw-2.epc.mnc001.mcc001.3gppnetwork.org">>],
