...
handle_request(ReqKey,
    ...
    SessionOpts0 = pgw_s5s8:init_session(IEs, LeftTunnel, ContextPreAuth, AAAopts),
...
handle_request(ReqKey,
    ...
    PCtx =
	case apply_bearer_change(LeftBearer, RightBearer, [], PCtx0, PCC) of
	    {ok, Result2} -> Result2;
	    {error, Err2} -> throw(Err2#ctx_err{context = Context, tunnel = LeftTunnel})
	end,
...
apply_bearer_change(LeftBearer, RightBearer, URRActions, PCtx0, PCC) ->
